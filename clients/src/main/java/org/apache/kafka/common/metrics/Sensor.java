...
public final class Sensor {
    ...
    private final String name; // 当前Sensor对象的名称
    private final Sensor[] parents; // Sensor数组类型
    private final List<Stat> stats;
    private final List<KafkaMetric> metrics;
    private final MetricConfig config;
    private final Time time;
    private volatile long lastRecordTime; // 最后一次执行record的时间戳
    private final long inactiveSensorExpirationTimeMs; // 过期Sensor的阈值
