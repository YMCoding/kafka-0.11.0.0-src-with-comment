...
public class LeaderAndIsrRequest extends AbstractRequest {
    ...
    private static final String PARTITION_STATES_KEY_NAME = "partition_states";//用来存储每个分区所在的brokerId isr集合 ar集合 zk_version信息
    ...
    public static class Builder extends AbstractRequest.Builder<LeaderAndIsrRequest> {
        ...
        private final Map<TopicPartition, PartitionState> partitionStates;//记录了每个分区的副本在当前Broker上的切换结果
