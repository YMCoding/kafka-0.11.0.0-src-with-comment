...
public class SaslChannelBuilder implements ChannelBuilder {
    ...
    private final SecurityProtocol securityProtocol; // 使用的安全协议 也就是security.protocol
    private final String clientSaslMechanism; // 使用的sasl机制 ，也就是sasl.mechanism配置项的值
    private final Mode mode; // 标志是客户端还是服务端
    private final JaasContext jaasContext;
    private final boolean handshakeRequestEnable;
    private final CredentialCache credentialCache;

    private LoginManager loginManager; // 封装LoginContext的logManager对象
    private SslFactory sslFactory;
    private Map<String, ?> configs; // 配置信息
