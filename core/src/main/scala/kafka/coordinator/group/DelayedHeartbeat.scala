 ...
 */
private[group] class DelayedHeartbeat(coordinator: GroupCoordinator, // GroupCoordinator对象
                                      group: GroupMetadata, // 对应的GroupMetadata
                                      member: MemberMetadata, // 对应的MemberMetadata
                                      heartbeatDeadline: Long, // delayedheartbeat的到期时间戳
                                      sessionTimeout: Long) // 指定了delayedheartbeat的到期时长
