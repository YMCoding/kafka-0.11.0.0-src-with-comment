...
class Replica(val brokerId: Int,//该副本所在的broker id
  ...
  //用来记录HW值，由leader维护，当isr集合中的所有副本成功同步，即消息被成功提交，
  ...
  //对于本地副本，记录追加到Log中最新消息的offset,可以直接从Log.nextOffsetMetadata字段中获取，对于远程副本，则有其他Broker发送请求
